...
public class CacheEvictionService {
    ...
    private static final String PREFIX = "wallet-service::";
    ...
    public void evictPayoutDetail(Long id) {
        evictByPattern(PREFIX + "payout::" + id);
    }

    public void evictAnalyticsCaches() {
        evictByPattern(PREFIX + "S5-F10::*");
        evictByPattern(PREFIX + "S5-F11::*");
    }
